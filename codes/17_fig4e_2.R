...
# Load the data =================================
counts = readRDS('../rhizobialStrains/data/counts.rds')
st = counts$samples
...
saveRDS(res1_,  'results/growthPredictionWithDiversity/reduced1.rds')
saveRDS(res1__, 'results/growthPredictionWithDiversity/reduced2.rds')
