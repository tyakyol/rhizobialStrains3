...
dom2 = read.delim('results/differentMembership/manhattanAbundance/dominants.csv', sep = ',', row.names = 1)
...
gen2 = read.delim('results/differentMembership/manhattanAbundance/generalists.csv', sep = ',', row.names = 1)
...
spe2 = read.delim('results/differentMembership/manhattanAbundance/specialists.csv', sep = ',', row.names = 1)
