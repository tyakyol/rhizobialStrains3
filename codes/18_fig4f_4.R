...
dom = read.delim('results/genomicPredictionForDiversity/dominantScores.txt', header = F)
gen = read.delim('results/genomicPredictionForDiversity/generalistScores.txt', header = F)
spe = read.delim('results/genomicPredictionForDiversity/specialistScores.txt', header = F)

dom2 = read.delim('results/genomicPredictionForDiversity/random/dominantScores.txt', header = F)
gen2 = read.delim('results/genomicPredictionForDiversity/random/generalistScores.txt', header = F)
spe2 = read.delim('results/genomicPredictionForDiversity/random/specialistScores.txt', header = F)
...
ggsave(filename = 'results/18_fig4f.pdf', device = 'pdf', width = 6, height = 6)
