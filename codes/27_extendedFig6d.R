...
# Load the data
do3 = list()
for(i in dir(path = 'results/genomicPredictionForAbundance/dominantVarImp/', full.names = T)) {
...
write.csv(lt0, 'results/manhattanAbundance/dominants.csv')

# Plot
pdf('results/27_extendedFig6d.pdf', width = 7, height = 5, useDingbats = F)
