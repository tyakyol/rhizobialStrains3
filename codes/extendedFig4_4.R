...
phyG = estimate_richness(otu_table(GG, taxa_are_rows = TRUE))
phyG = phyG[, c(1, 2, 7, 8, 9)]
phyD = estimate_richness(otu_table(DD, taxa_are_rows = TRUE))
phyD = phyD[, c(1, 2, 7, 8, 9)]
phyS = estimate_richness(otu_table(SS, taxa_are_rows = TRUE))
phyS = phyS[, c(1, 2, 7, 8, 9)]
...
saveRDS(res1_,  'results/growthPredictionWithDiversity/speciesCount1.rds')
saveRDS(res1__, 'results/growthPredictionWithDiversity/speciesCount2.rds')
