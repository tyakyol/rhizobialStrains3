...
do3 = list()
for(i in dir(path = 'results/genomicPredictionForDiversity/generalistVarImp/', full.names = T)) {
...
write.csv(lt0, 'results/manhattanDiversity/generalists.csv')

pdf('results/25_extendedFig6b.pdf', width = 7, height = 5, useDingbats = F)
