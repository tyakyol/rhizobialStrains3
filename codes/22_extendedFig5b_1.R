...
set.seed(25); raG = sample(colSums(GG), size = 603, replace = F)
set.seed(100); raD = sample(colSums(DD), size = 603, replace = F)
set.seed(400); raS = sample(colSums(SS), size = 603, replace = F)
