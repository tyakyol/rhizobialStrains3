...
dom2 = read.delim('../rhizobialStrains4/results/manhattanDiversity/dominants.csv', sep = ',', row.names = 1)
...
gen2 = read.delim('../rhizobialStrains4/results/manhattanDiversity/generalists.csv', sep = ',', row.names = 1)
...
spe2 = read.delim('../rhizobialStrains4/results/manhattanDiversity/specialists.csv', sep = ',', row.names = 1)
