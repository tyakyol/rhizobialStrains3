...
# Load the data
do3 = list()
for(i in dir(path = 'results/genomicPredictionForDiversity/specialistVarImp/', full.names = T)) {
...
write.csv(lt0, 'results/manhattanDiversity/specialists.csv')

# Plot
pdf('results/26_extendedFig6c.pdf', width = 7, height = 5, useDingbats = F)
