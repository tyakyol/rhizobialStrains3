...
write.csv(mergD, 'results/shannonDiversity.csv')
...
saveRDS(res1_,  'results/growthPredictionWithDiversity/shannon1.rds')
saveRDS(res1__, 'results/growthPredictionWithDiversity/shannon2.rds')
