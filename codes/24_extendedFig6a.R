...
# Load the data
do3 = list()
for(i in dir(path = 'results/genomicPredictionForDiversity/dominantVarImp/', full.names = T)) {
...
write.csv(lt0, 'results/manhattanDiversity/dominants.csv')

# Plot
pdf('results/24_extendedFig6a.pdf', width = 7, height = 5, useDingbats = F)
