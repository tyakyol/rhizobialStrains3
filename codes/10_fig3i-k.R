...
ggsave('results/10_extendedFig3e.pdf', height = 5, width = 7)
...
pdf(file = 'results/10_fig3i.pdf', useDingbats = F, width = 5, height = 5)
par(mar = c(0,0,0,0))
plot(gr,
...
pdf(file = 'results/10_fig3k.pdf', useDingbats = F, width = 6, height = 6)
