...
full = readRDS('results/growthPredictionWithDiversity/shannon2.rds')
redu = readRDS('results/growthPredictionWithDiversity/reduced2.rds')
rand = readRDS('results/growthPredictionWithDiversity/randomShannon2.rds')
...
ggsave(filename = 'results/19_fig4f.pdf', device = 'pdf', width = 6, height = 6)
