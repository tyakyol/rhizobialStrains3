...
# Load the data
do3 = list()
for(i in dir(path = 'results/genomicPredictionForAbundance/generalistVarImp/', full.names = T)) {
...
write.csv(lt0, 'results/manhattanAbundance/generalists.csv')

# Plot
pdf('results/28_extendedFig6e.pdf', width = 7, height = 5, useDingbats = F)
