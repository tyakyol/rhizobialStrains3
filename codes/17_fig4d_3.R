...
mergD = cbind(mergD, eveG, eveD, eveS)
...
saveRDS(res1_,  'results/growthPredictionWithDiversity/sheldon1.rds')
saveRDS(res1__, 'results/growthPredictionWithDiversity/sheldon2.rds')
